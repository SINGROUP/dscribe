...
//=========================================================
void soapGeneral(py::array_t<double> cArr, py::array_t<double> positions, py::array_t<double> HposArr, py::array_t<int> atomicNumbersArr, double rCut, double cutoffPadding, int totalAN,int Nt,int gnsize, int lMax, int Hs, double alpha, py::array_t<double> rwArr, py::array_t<double> gssArr)
{
  ...
  for (int i = 0; i < Hs; i++) {
      ...
      accumP(c, Ps, Nt, lMax, gnsize,rCut2, i);
  }
