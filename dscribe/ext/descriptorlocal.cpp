...
DescriptorLocal::DescriptorLocal(bool periodic, string average, double cutoff, string normalization)
...
)
{
    ...
    if (is_periodic) {
        System center_extension = extend_system(centers, center_indices, cell, pbc, this->cutoff);
