...
void soapGTODevX(py::array_t<double> derivatives, py::array_t<double> desciptor, py::array_t<double> Apos, py::array_t<double> Hpos, py::array_t<double> alphas, py::array_t<double> betas, py::array_t<int> atomicNumbers, double rCut, double cutoffPadding, int totalAN, int Nt, int Ns, int lMax, int Hs, double eta, bool crossover, py::array_t<int> indices, bool return_descriptor);
