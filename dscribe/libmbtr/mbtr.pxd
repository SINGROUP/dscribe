...
cdef extern from "mbtr.h":
  cdef cppclass MBTR:
        ...
        map[string,vector[double]] getK1(string, string, map[string, float], float, float, float, float) except +
        map[string,vector[double]] getK2(vector[vector[double]], vector[vector[int]], string, string, map[string, float], float, float, float, float) except +
        map[string,vector[double]] getK3(vector[vector[double]], vector[vector[int]], string, string, map[string, float], float, float, float, float) except +
